...
const plans = [
  {
    name: 'Essential',
    tagline: 'Semua yang kamu butuhkan untuk mulai.',
    lifetime: 2000000,
    annual: 800000,
    badge: null,
    features: [
      ...
      'Purchase Order & terima barang',
      'Laporan keuangan & laba bersih',
      'Multi kasir, multi shift',
      'Backup & restore database',
      'Pantau dari HP (Android App)',
    ],
  },
  {
    name: 'Plus',
    tagline: 'Analitik mendalam dan manajemen supplier.',
    lifetime: 3000000,
    annual: 1300000,
    ...
    features: [
      ...
      'Modul Supplier + performa & hutang',
      'Laporan cash flow harian',
      'Laporan per produk & margin',
      'Laporan diskon detail',
